...
public class GKGaussianDistribution private constructor(
    ...
    // 100% of values fall within three deviations of the mean, so the range spans six deviations.
    ...
    // Marsaglia polar method: a standard, textbook-correct Gaussian sampler. GameplayKit's exact
    // internal algorithm is undocumented, so this matches the documented mean/deviation contract
    // rather than being bit-for-bit identical to Apple's implementation.
