 ...
 * Apple's real `GKNoiseSource` exposes no public sampling API of its own — only [GKNoise] samples
 * a source, via [GKNoise.value] — and subclassing it isn't meaningfully supported by Apple's
