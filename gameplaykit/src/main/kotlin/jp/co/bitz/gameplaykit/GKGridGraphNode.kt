...
// A GKGraphNode with a 2D integer grid position. cost/estimatedCost use Chebyshev (chessboard)
// distance, so an orthogonal step and a diagonal step both cost 1 — matching GKGridGraph's uniform
// per-step movement model.
