...
// GKPath. 3D paths (Apple also supports Vector3-based paths) are out of scope for this port; the
// steering goals that use a path (toFollowPath/toStayOnPath) operate in the agent's XY plane.
public class GKPath(
