...
// A node in a GKQuadtree. Automatically created and managed by GKQuadtree as elements are added and
// removed; the public surface only exposes the node's bounding quad, matching GameplayKit's opaque
// node handle (GKQuadtreeNode carries no publicly documented behavior of its own).
