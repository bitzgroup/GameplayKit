...
This repository is a **new, unstarted project**. It currently contains only a `README.md`, `.gitignore`, and `ROADMAP.md`; there is no source code or build configuration yet.
...
See `ROADMAP.md` for the full implementation plan and progress checklist, organized by GameplayKit subsystem.
